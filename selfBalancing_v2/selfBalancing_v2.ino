...
void setup() 
{
  // PWM.h Setup
  Timer1.initialize();
  Timer1.pwm(nidecPWM, 0);
  Timer1.setPeriod(50);
  Timer1.setPwmDuty(nidecPWM, 0);
 ...
 //Serial.println(pwmOut);
  ...
  if(angle >= 20 || angle <= -20)  // if angle is greater than +/- 20° than the Nidec motor will stop
      ...
      else
      {
          ...
          Timer1.setPwmDuty(nidecPWM, pwmOut2);
          }
